...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [781138.435200, 9228747.036500, 802757.486000, 9243507.677000], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32748',
...
map.getView().fit([781138.435200, 9228747.036500, 802757.486000, 9243507.677000], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tutupan Lahan Kota Bandung</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (337 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini merupakan hasil visualisasi WebGIS yang menampilkan tutupan lahan Kota Bandung berdasarkan data raster Sentinel-2 ESRI Land Cover, diintegrasikan dengan data vektor batas administrasi kecamatan Kota Bandung. Peta dibuat menggunakan plugin QGIS2Web pada perangkat lunak QGIS dan dipublikasikan secara online melalui GitHub Pages.';
            }
